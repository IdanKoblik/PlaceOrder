...
const translations: Record<Language, Translation> = {
  en: {
    ...
    messages: {
      ...
      defaultPasswordSet: 'Default admin password set to: admin123',
    ...
    password: {
      ...
      storedInDatabase: 'admin123 (stored in database)',
  ...
  he: {
    ...
    messages: {
      ...
      defaultPasswordSet: 'סיסמת מנהל ברירת מחדל הוגדרה ל: admin123',
    ...
    password: {
      ...
      storedInDatabase: 'admin123 (שמורה במסד הנתונים)',
  ...
  ru: {
    ...
    messages: {
      ...
      defaultPasswordSet: 'Пароль администратора по умолчанию установлен: admin123',
    ...
    password: {
      ...
      storedInDatabase: 'admin123 (сохранён в базе данных)',
